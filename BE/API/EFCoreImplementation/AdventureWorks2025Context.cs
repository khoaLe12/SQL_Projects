...
public partial class AdventureWorks2025Context : DbContext, IAdventureWorks2025Context
{
    ...
    public virtual DbSet<SalesOrderDetail1> SalesOrderDetail1s { get; set; }
    ...
    public virtual DbSet<sysDAOInfo> SysDAOInfos { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SalesOrderDetail1>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("SalesOrderDetail1", "Sales");

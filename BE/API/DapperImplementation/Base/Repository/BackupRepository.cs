...
{
    private readonly AdventureWorks2025BackupConnection _connection;
    ...
    public BackupRepository(AdventureWorks2025BackupConnection connection)
    {
    ...
    protected virtual DynamicParameters getParamForProc(string scName, string spName, DynamicParameters parameters)
    {
        ...
        {
            if (paramItem.PARAMETER_MODE is null || paramItem.PARAMETER_NAME is null || paramItem.DATA_TYPE is null) continue;
